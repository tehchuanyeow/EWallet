...
{
    public class PersonalAccount : ResourceAccount
    {
        public PersonalAccount(int acctnumber, string acctpassword, string acctusername, double acctbalance, double amtdeposit, double amtwithdraw, List<Invoice> invoicehistory, List<Transaction> transactionhistory) : base(acctnumber, acctpassword, acctusername, acctbalance, amtdeposit, amtwithdraw, invoicehistory, transactionhistory)
        { }
